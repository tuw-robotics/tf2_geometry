...
TEST(pose2d, transform_into_parent)
{
  // Point
  double tolerance = 0.001;
  tf2::Transform2D pose0(3.0, -1.0, M_PI/4.0);
  ...
  tf2::Point2D point_in_base = pose0.transform_into_parent(point_in_target);
  ...
  tf2::Transform2D pose_in_base = pose0.transform_into_parent(pose_in_target);
...
TEST(pose2d, inverse)
{
  ...
  tf2::Point2D point_in_base = pose0inv.transform_into_parent(point_in_target);
